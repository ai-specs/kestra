...
| dsh Release to GHCR | `dsh-release-ghcr.yml` | 纯源码构建并发布 kestra 镜像（`BASE_IMAGE = kestra-base:latest`）到 `ghcr.io/ai-specs/kestra` |
...
| Pre Release | `pre-release.yml` | tag 触发、发 pre-release |
